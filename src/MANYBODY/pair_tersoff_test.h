...
PairStyle(tersoff/test,PairTersoffTest)

#else

#ifndef LMP_PAIR_TERSOFF_TEST_H
#define LMP_PAIR_TERSOFF_TEST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTersoffTest : public Pair {
 public:
  PairTersoffTest(class LAMMPS *);
  virtual ~PairTersoffTest();
  ...
  static const int NPARAMS_PER_LINE = 18;
